...
7. Double-click the main app file to start the tool
8. If Windows asks for permission, choose Yes
9. Keep the tool open while you connect your phone by USB
10. Wait for the device name or status to appear in the app
